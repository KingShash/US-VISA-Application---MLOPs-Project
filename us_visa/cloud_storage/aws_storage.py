...
class SimpleStorageService:
    ...
    @staticmethod
    def read_object(object_name: ObjectSummary, decode: bool = True, make_readable: bool = False) -> Union[StringIO, str, bytes]:
        """
    ...
    def load_model(self, model_name: str, bucket_name: str, model_dir: Optional[str] = None) -> object:
        ...
        try:
            ...
            model_obj = cast(bytes, self.read_object(file_object, decode=False))
    ...
    def get_df_from_object(self, object_: ObjectSummary) -> DataFrame:
        """
